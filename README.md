...
Пакет реализует логику автоматической загрузки классов и ресурсов используя 
карту путей, префиксы и имя ресурса.
...
[исходные коды]: https://github.com/Bashka/bricks_autoload/releases
[PHPUnit]: http://phpunit.de/
[обсуждение]: https://github.com/Bashka/bricks_autoload/issues
